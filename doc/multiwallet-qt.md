...
Only requiring some minor changes is playt.cpp.
...
Changes to playt.cpp
----------------------
playt.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
