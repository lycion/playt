    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PlayT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PlayT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and playt: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PlayT Core"), this);
    aboutAction->setStatusTip(tr("Show information about PlayT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PlayT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PlayT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PlayT addresses"));
    ...
    openAction->setStatusTip(tr("Open a playt: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PlayT Core help message to get a list with possible PlayT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PlayT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PlayT network", "", count));
}
...
{
    QString strTitle = tr("PlayT Core"); // default title
