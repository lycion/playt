    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PlayT Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About PlayT Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  playt-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PlayT Core is shutting down...") + "<br /><br />" +
