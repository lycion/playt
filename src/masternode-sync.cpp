...
void CMasternodeSync::Process()
{
    ...
    if(fDebug) LogPrintf("CMasternodeSync::Process() - RequestedMasternodeAssets : %d (0)\n", RequestedMasternodeAssets);
    if(fDebug) LogPrintf("CMasternodeSync::Process() - IsBlockchainSynced() : %s (0-1)\n", 
    ...
    if(fDebug) LogPrintf("CMasternodeSync::Process() - RequestedMasternodeAssets : %d (1) \n", RequestedMasternodeAssets);
    ...
    BOOST_FOREACH(CNode* pnode, vNodes)
    {
        ...
        if(fDebug) LogPrintf("CMasternodeSync::Process() (2) \n");
        ...
        if(RequestedMasternodeAssets == MASTERNODE_SYNC_SPORKS){
            ...
            if(fDebug) LogPrintf("CMasternodeSync::Process() (2-1) \n");
            pnode->FulfilledRequest("getspork");

            if(fDebug) LogPrintf("CMasternodeSync::Process() (2-2) \n");

            pnode->PushMessage("getsporks"); //get current network sporks
            if(fDebug) LogPrintf("CMasternodeSync::Process() (2-3) \n");

            if(RequestedMasternodeAttempt >= 2) 
                GetNextAsset();
            if(fDebug) LogPrintf("CMasternodeSync::Process() RequestedMasternodeAttempt : %d (2-4) \n", RequestedMasternodeAttempt);

            RequestedMasternodeAttempt++;

            if(fDebug) LogPrintf("CMasternodeSync::Process() RequestedMasternodeAttempt : %d (2-5) \n", RequestedMasternodeAttempt);
            
            return;
        }

        if(fDebug) LogPrintf("CMasternodeSync::Process() (3) \n");
        ...
        if(fDebug) LogPrintf("CMasternodeSync::Process() (4) \n");
        ...
        if(fDebug) LogPrintf("CMasternodeSync::Process() (6) \n");
    }
}
