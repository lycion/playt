...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* PlayT features */
    { "playt",               "masternode",             &masternode,             true,      true,       false },
    { "playt",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "playt",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "playt",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "playt",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "playt",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "playt",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "playt",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "playt",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use playtd, or the -server option to playt-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> playt-cli " + methodname + " " + args + "\n";
}
