...
/* *** BEGIN DARKSEND MAGIC - PLA **********
    Copyright (c) 2014-2015, PlayT Developers
        eduffield - evan@playtpay.io
        udjinm6   - udjinm6@playtpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat PlayT and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    if (!pwalletMain->SelectCoinsDark(nValueMin, nBalanceNeedsAnonymized, vCoins, nValueIn, 0, nDarksendRounds))
    {
        ...
        if (pwalletMain->SelectCoinsDark(nValueMin, 8889999*COIN, vCoins, nValueIn, -2, 0))
        {
