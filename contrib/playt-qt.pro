...
RESOURCES += src/qt/playt.qrc src/qt/playt_locale.qrc
TRANSLATIONS += src/qt/locale/playt_bg.ts \
                src/qt/locale/playt_de.ts \
                src/qt/locale/playt_en.ts \
                src/qt/locale/playt_es.ts \
                src/qt/locale/playt_fi.ts \
                src/qt/locale/playt_fr.ts \
                src/qt/locale/playt_it.ts \
                src/qt/locale/playt_ja.ts \
                src/qt/locale/playt_pl.ts \
                src/qt/locale/playt_pt.ts \
                src/qt/locale/playt_ru.ts \
                src/qt/locale/playt_sk.ts \
                src/qt/locale/playt_sv.ts \
                src/qt/locale/playt_vi.ts \
                src/qt/locale/playt_zh_CN.ts \
                src/qt/locale/playt_zh_TW.ts
